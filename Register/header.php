  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo INDEX_PATH;?>./index.php">Home <span class="sr-only">(current)</span></a>
      </li>
      
      <li>
        <?php
		if (isset($_SESSION['user']) && $_SESSION['role']=='P'){?>
		<a class="nav-link" href=""><?php echo $_SESSION['user'];?></a></li>
		</li>
		<li class="nav-item">
        <a class="nav-link" href="<?php echo INDEX_PATH;?>student_detail.php">Your Child</a>
      </li>
       <li class="nav-item">
