                   ...
                   <div class="row">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <label>Student Age Group: <span class="required">*</span></label>
                          <select id="stud_class" name="stud_class" class="form-control " placeholder="Class" type="text">
...
$("#save").click(function(){
  ...
  var gender = $('input[name="gender"]:checked').val();
   $.ajax({
            ...
            data: {"img_name":img_name,"city":city,"gender":gender,"stud_name":stud_name,"parent_name":parent_name,"email":email,"contact_no":contact_no,"stud_class":stud_class,"dob":dob,"activity":activity},
